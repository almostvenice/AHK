...
import { loadDictionary, predictWordsFromQuadrants } from './services/wordPredictor'
...
// Set up IPC handlers for word prediction and API calls
function setupIpcHandlers() {
  // Handle API suggestion requests
  ipcMain.handle('fetch-suggestions', async (_, prompt: string) => {
  ...
  ipcMain.handle('predict-words', (_, positionSequence: number[]) => {
